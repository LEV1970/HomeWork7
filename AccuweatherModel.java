    ...
    public void getWeather(String selectedCity, Period period) throws IOException {
        switch (period) {
            case NOW:
                ...
                //Weather cityWeather = objectMapper.readValue(weatherResponse,Weather.class );
                //System.out.println(cityWeather);

                //WeatherResponse weatherResponse3 = objectMapper.readValue(weatherResponse, WeatherResponse.class);

                //String temperatureWeather = objectMapper.readTree(weatherResponse).get(1).at("/Temperature").asText();
